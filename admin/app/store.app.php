    ...
    function add()
    {
        ...
        else
        {
            ...
            $data = array(
			    ...
			    'address'      => $_POST['address'],//xuewangzi20150125 刷销量
    ...
    public function edit()
    {
        ...
        if (!IS_POST)
        {
			...
			$fenglist= $fengc->find(array(
			 ...
			 'conditions' => "1=1 and store_id=".$id,
        ...
        else
        {
            ...
            $data = array(
				...
				'operate_time'      => $_POST['operate_time'],
				'send_address'      => $_POST['send_address'],
				'credit_value' => $_POST['credit_value'],//xuewangzi 20150125 后台信誉值
                'zipcode'      => $_POST['zipcode'],
                'tel'          => $_POST['tel'],
                'sgrade'       => $_POST['sgrade'],
                'end_time'     => empty($_POST['end_time']) ? 0 : gmstr2time(trim($_POST['end_time'])),
				...
				'is_has' => $_POST['is_has'],
				'is_open_shua' => $_POST['is_open_shua'],//xuewangzi20150125 刷销量
            );
			...
			$fenginfo = $fengc->get("store_id=".$id);
		...
		for($i=1;$i<4;$i++)
		 ...
		 $fengc->edit("store_id=".$id." and levol=".$i,$data_levol);
    ...
    function batch_edit()
    {
        ...
        else
        {
            ...
            if ($_POST['is_open_pay'] > -1)
            {
			   ...
			   if ($_POST['is_open_shua'] > -1)//xuewangzi20150125 销量
            {
                $data['is_open_shua'] = $_POST['is_open_shua'];//xuewangzi20150125 销量
            }
