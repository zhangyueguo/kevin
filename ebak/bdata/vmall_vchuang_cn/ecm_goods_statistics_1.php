...
E_D("replace into `ecm_goods_statistics` values('11','2','0','0','0','0','0');");
E_D("replace into `ecm_goods_statistics` values('12','3','0','0','0','0','0');");
E_D("replace into `ecm_goods_statistics` values('13','2','0','0','0','0','0');");
E_D("replace into `ecm_goods_statistics` values('14','1','0','0','0','0','0');");
E_D("replace into `ecm_goods_statistics` values('15','4','0','1','1','0','0');");
...
E_D("replace into `ecm_goods_statistics` values('94','9','0','0','0','0','0');");
...
E_D("replace into `ecm_goods_statistics` values('98','5','0','1','0','0','0');");
E_D("replace into `ecm_goods_statistics` values('99','28','0','3','1','0','0');");
