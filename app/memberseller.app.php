...
//class MembersellerApp extends MemberbaseApp
class MembersellerApp extends BusinessbaseApp
{
    public $_feed_enabled = false;
    function __construct()
    {
        $this->MembersellerApp();
    }
    function MembersellerApp()
    {
        parent::__construct();
        $ms =& ms();
	...
	//print_r($wxchqr_info);
     ...
     $this->assign('weixin_user_info', $weixin_user_info);
        ...
        /* 当前位置 */
        $this->_curlocal(LANG::get('member_center'),    url('app=member'),          //用户中心    用户概况
                         LANG::get('overview'));
    ...
    public function approve()
    {
        ...
        if(IS_POST)
        {
            $images = array('card_first','card_end');
        ...
        $profile = $model_user->get_info($user_id);

        $this->assign('profile',$profile);


        $this->display('member.approve.html');
    }
    ...
    public function security()
    {
        ...
        $this->display('member.security.html');
    }
