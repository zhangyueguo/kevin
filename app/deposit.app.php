...
class DepositApp extends DepositbaseApp
{
	...
	function recharge()
	{
		...
		$uri = $_GET['balance_sid'];
		$this->assign('uri',$uri);
		//echo urldecode('http%3A%2F%2F192.168.123.53%2Fpecmall%2Findex.php%3Fapp%3Ddepopaynotify%26act%3Dnotify%26tradesn%3D2016091309381979&return_url=http%3A%2F%2F192.168.123.53%2Fpecmall%2Findex.php%3Fapp%3Ddepopaynotify%26tradesn%3D2016091309381979&subject=充值&out_trade_no=2016091309381979&total_fee=0.5&payment_type=1&seller_email=yuhui.f%40163.com&sign=43e8950a0794dae322ef34e346bc9b4c&sign_type=MD5');exit;
		...
		else
		{
            ...
            /*	if (!$payment_model->in_white_list($payment_code))
				...
				$payment_info  = $payment_model->get("payment_code ='{$payment_code}' AND store_id=2");
