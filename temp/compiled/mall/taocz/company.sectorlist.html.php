    ...
    <div id="right">
        ...
        <div class="submenu">
            <ul class="tab">
                ...
                <li class="active <?php if (($this->_foreach['member_submenu']['iteration'] <= 1)): ?>first<?php endif; ?>"><h2><a href="index.php?app=company&act=sectorlist">部门列表</a></h2></li>
...
?>
                                <tr>
                                    ...
                                    <td  width="200">
                                        <span>
                                            <a href="index.php?app=company&amp;act=sect_edit&amp;id=<?php echo $this->_var['gcategory']['id']; ?>">编辑</a>
                                        |
                                        <a href="javascript:if(confirm('删除该分类将会同时删除该分类的所有下级分类，您确定要删除吗'))window.location = 'index.php?app=company&amp;act=drop&amp;id=<?php echo $this->_var['gcategory']['id']; ?>';">删除</a>
                                            <?php if ($this->_var['region']['layer'] < $this->_var['max_layer']): ?>
                                            | <a href="index.php?app=company&amp;act=addsector&amp;pid=<?php echo $this->_var['gcategory']['id']; ?>">添加子部门</a>
                                            <?php endif; ?>
