    ...
    <div id="right">
        ...
        <div class="wrap">
            <div class="public">
                ...
                <form method="post" enctype="multipart/form-data" id="profile_form" action="index.php?app=company&act=addzizhi&type=<?php if($_GET['type']=='add'){
                    echo 'add';
...
?>
                    <li class="card">
                        ...
                        <div class="handle clearfix">
                            ...
                            <div class="card-handle">
                                ...
                                <a _href=''>所属公司&nbsp;&nbsp;不可编辑</a>
                                <?php else: ?>
                                <a href="<?php echo url('app=company&act=addzizhi&type=edit&bid=' . $this->_var['bank']['id']. ''); ?>">编辑</a>
                                <a href="<?php echo url('app=company&act=addzizhi&type=drop&bid=' . $this->_var['bank']['id']. ''); ?>" onclick="return confirm('删除后不可恢复，您确认吗？')">删除</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="card add-card">
                        <a href="<?php echo url('app=company&act=addzizhi&type=add'); ?>" title="添加开票信息"></a>
                    </li>
                </ul>
                <?php endif; ?>
            </div>
