...
?>
                				...
                				<dd class="desc"><a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>" target="_blank"><?php echo sub_str(htmlspecialchars($this->_var['goods']['goods_name']),28); ?></a></dd>
                				<dd class="price twofloat clearfix"><em><?php echo $this->_var['goods']['price']; ?></em><span>最新成交<b><?php echo $this->_var['goods']['sales_info']; ?></b>笔</span></dd>
                            	<dd class="delivery twofloat clearfix hidden"><em></em><span></span></dd>
                            	<dd class="storeinfo twofloat clearfix">
                					<em><a href="<?php echo url('app=store&id=' . $this->_var['goods']['store_id']. ''); ?>" target="_blank"><?php echo sub_str(htmlspecialchars($this->_var['goods']['store_name']),30); ?></a></em>
                                	<span class="hidden">
                                    	...
                                    	<?php endif; ?>
										<a style="color:#FF6600;" href="javascript:add_datapacket(<?php echo $this->_var['goods']['goods_id']; ?>);" class="btn_add_datapacket">加入数据包</a>
                                	</span>
                				</dd>
