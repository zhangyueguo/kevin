        ...
        <div class="public">
            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    <div class="setup">
                        ...
                        <div class="images">
                        <?php if ($this->_var['store']['images']): ?>
                        <p>
                        <img width="120" height="120" src="<?php echo $this->_var['store']['images']; ?>" /> 
                        </p>
                        ...
                        <table style="width: 100%">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <p class="td_block"><input id="images" type="file" class="text width_normal" name="images" /></p>
