                    ...
                    <table class="infoTable">
                        ...
                        <tr>
                            <th class="paddingT15">
                                营业执照:</th>
                            <td class="paddingT15 wordSpacing5">
                                <input class="infoTableFile2" id="brand_logo" type="file" name="img_license" />
                        ...
                        <?php if ($this->_var['store']['img_license']): ?>
                        <tr>
                            <th class="paddingT15">
                            </th>
                            <td class="paddingT15 wordSpacing5">
                                <img src="<?php echo $this->_var['store']['img_license']; ?>" class="makesmall" max_width="120" max_height="90" />
                            </td>
                        </tr>
                        <?php endif; ?>
