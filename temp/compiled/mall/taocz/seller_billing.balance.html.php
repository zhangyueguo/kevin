...
?>
                            <tr>
                                ...
                                <td><?php echo date("Y-m-d H:i:s",$this->_var['list']['balance_time']); ?></td><td>【<a href="javascript:;" onclick="renew(this,<?php echo $this->_var['list']['id']; ?>)">恢复额度</a>】&nbsp;&nbsp;【<a href="">提额</a>】<br>【<a href="">降额</a>】&nbsp;&nbsp;【<a href="javascript:;" onclick="revoke(this,<?php echo $this->_var['list']['id']; ?>)">撤销记账</a>】<br></td>
                            </tr>
...
<script type="text/javascript">
    function renew(obj,id){
        $.post("index.php?app=billing_order_seller&act=renew", {id: id},
           function(data){
            if(data == 'success'){
                alert('操作成功！');
