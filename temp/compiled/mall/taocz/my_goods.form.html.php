                ...
                <form method="post" id="goods_form">
                    <div class="information_index">
                        ...
                        <div class="add_spec" dialog_title="编辑商品规格" ectype="dialog_contents" style="display: none">
                            <!--<form>-->
                            <p>您最多可以添加两种规格（如：颜色和单双面）规格名称可以自定义，如只有一项规格另一项留空。</p>
...
?>
                            ...
                            <div class="products">
                                <ul>
                                    ...
                                    <!-- <li>
                                        <h2>推荐分成: </h2>
                                        <div class="arrange"><input type="text" name="recom" value="<?php echo htmlspecialchars($this->_var['goods']['recom']); ?>" class="text width_normal" /> 如填0.2 </div>
                                    </li> -->
...
?>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            <div class="box_arr" ectype="no_spec"  style="display: none;">
                                                ...
                                                <p class="pos_txt">您最多可以添加两种商品规格（如：颜色，单双面）如商品没有规格则不用添加</p>
                                            </div>
                                    ...
                                    <li ectype="has_integral">
                                       <h2>赠送积分:</h2>
                                       <div class="arrange"><input name="has_integral" value="<?php echo $this->_var['goods']['has_integral']; ?>" type="text" class="text width_short" /><span class="gray">买家购买该商品后可获得的积分，默认为0，设置后，卖家的这部分积分将被冻结，该积分将从您的账号中扣除，请慎重填写。</span></div>
                                    </li>
                                    <li ectype="max_exchange">
                                       <h2>抵扣价款:</h2>
                                       <div class="arrange"><input name="max_exchange" value="<?php echo $this->_var['goods']['max_exchange']; ?>" type="text" class="text width_short" /><span class="gray">设置允许买家最多可使用多少积分抵扣价款。</span></div>
                                    </li>
                                    <?php endif; ?>
