                    ...
                    <div class="information">
                        ...
                        <div class="info individual">
                            <table>
                                ...
                                <tr>
                                    <th>身份证号:</th>
                                    <td><input type="text" class="text width_normal" name="card" value="<?php echo htmlspecialchars($this->_var['profile']['card']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>手机号码:</th>
                                    <td><input type="text" class="text width_normal" name="phone" value="<?php echo htmlspecialchars($this->_var['profile']['phone']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>固定电话:</th>
                                    <td><input type="text" class="text width_normal" name="phone_g" value="<?php echo htmlspecialchars($this->_var['profile']['phone_g']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>所在企业:</th>
                                    <td><input type="text" class="text width_normal" name="companyname" value="<?php echo htmlspecialchars($this->_var['profile']['companyname']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>所在部门:</th>
                                    <td><input type="text" class="text width_normal" name="sectname" value="<?php echo htmlspecialchars($this->_var['profile']['sectname']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>职务:</th>
                                    <td><input type="text" class="text width_normal" name="juese" value="<?php echo htmlspecialchars($this->_var['profile']['juese']); ?>" /></td>
                                </tr>
