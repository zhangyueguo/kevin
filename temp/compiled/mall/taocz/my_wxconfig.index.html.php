                ...
                <div class="information">
                    <div class="setup info shop">
                        <form  enctype="multipart/form-data" method="post"  id="my_wxconfig_form" m>
                                 ...
                                 <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <select class="querySelect" name="type"><?php echo $this->html_options(array('options'=>$this->_var['type'],'selected'=>$this->_var['wx_config']['type'])); ?>
			  </select></p>
                         ...
                         <?php if ($this->_var['wx_config']['pic']): ?>
                                              <p class="td_block">
                                        
            <a target="_blank" href="<?php echo $this->_var['wx_config']['pic']; ?>" >
            <img width="50" height="50" src="<?php echo $this->_var['wx_config']['pic']; ?>"  />
            </a>
            </p>
            <?php endif; ?></p>
