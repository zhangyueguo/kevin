...
<div class="foot-copyright">Copyright &copy; 2011-2014 <a href="http://vmall.vchuang.cn">微创动力微信商城</a> 版权所有 <?php if ($this->_var['icp_number']): ?><?php echo $this->_var['icp_number']; ?><?php endif; ?> <?php echo $this->_var['statistics_code']; ?></div>
...
?>
           ...
           <!-- </div>
            ...
            <div class="mainbox ob4"><a style="text-decoration:none;" href="http://taobao.vchuang.cn" target="_blank"><b></b><span>关注微博</span><div class="clr"></div></a></div>
