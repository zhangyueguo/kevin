...
?>
        <tr class="tatr2">
            ...
            <td align="center"><?php echo date("Y-m-d H:i:s",$this->_var['template']['start_time']); ?></td>
            <td align="center"><?php echo date("Y-m-d H:i:s",$this->_var['template']['join_end_time']); ?></td>
            <td align="center"><?php echo date("Y-m-d H:i:s",$this->_var['template']['end_time']); ?></td>
