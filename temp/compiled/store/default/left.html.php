        <div class="user">
            ...
            <div class="user_data">
                ...
                <p>创店时间: <?php echo date("Y-m-d",$this->_var['store']['add_time']); ?></p>
...
?>
                ...
                <?php endif; ?>
                 ...
                 <?php if ($this->_var['store']['service']): ?>
                <p>保证金：
                <?php $_from = $this->_var['store']['service']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cert');if (count($_from)):
    foreach ($_from AS $this->_var['cert']):
?>
                 <span><img  alt="<?php echo $this->_var['cert']['name']; ?>" src="<?php echo $this->_var['cert']['img']; ?>" /></span>
                  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                  </p>
                <?php endif; ?>
                ...
                <?php endif; ?>
                 ...
                 <p>营业时间:<?php echo htmlspecialchars($this->_var['store']['operate_time']); ?></p>
