...
?>
        ...
        <ul id="btn_list">
            <a href="javascript:collect_goods(<?php echo $this->_var['goods']['goods_id']; ?>);"><li id="btn_list1" title="收藏该商品"></li></a>
    ...
    <div class="ware_text">
        ...
        <div class="rate">
               ...
               <div id="not_pro" <?php if ($this->_var['goods']['_specs']['0']['is_pro']): ?> style="display:none"<?php endif; ?>>
               		<div <?php if ($this->_var['goods']['if_open']): ?>style="display:none;"<?php endif; ?>>
                        <span class="letter1" >价格: </span><span class="fontColor3" ectype="goods_price"><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?></span>
                    </div>
                    <div <?php if (! $this->_var['goods']['if_open']): ?>style="display:none;"<?php endif; ?>>
                        <span class="letter1" >价格: </span><del><span style="font-size:14px;" ectype="goods_price"><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?></span></del><br/>
                        <span class="letter1">促销:</span><em class="vip_price"><?php echo $this->_var['ugrade_name']; ?></em><?php if ($this->_var['visitor']['user_id']): ?><span class="fontColor3" ectype="member_price"><?php echo price_format($this->_var['goods']['price']); ?></span><?php else: ?><em class="desc">登录后确认是否享有此优惠</em><?php endif; ?>
                    </div>
               </div>
               ...
               <span>赠送积分：</span><?php echo ($this->_var['goods_integral_info']['has_integral'] == '') ? '0' : $this->_var['goods_integral_info']['has_integral']; ?> 积分<br />
               <span style="color: #CEAA00;">可用积分</span>：<?php echo ($this->_var['goods_integral_info']['max_exchange'] == '') ? '0' : $this->_var['goods_integral_info']['max_exchange']; ?> 积分<br />
               <?php endif; ?>        
...
?><?php echo $this->_var['tag']; ?>&nbsp;&nbsp;&nbsp;<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?><br />
            ...
            所在地区: <?php echo htmlspecialchars($this->_var['store']['region_name']); ?></span>
        ...
        <?php echo $this->_var['goods']['scan_code']; ?><br/>
            ...
            <?php if ($this->_var['visitor']['user_id']): ?>
             ...
             <Br /> 
               ...
               分享商品链接：<input name="website" id="website" type="text" class="cms_input fl" style=" height:20px; width:320px;" value="<?php echo $this->_var['site_url']; ?>/<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. '&name='); ?><?php echo $this->_var['visitor']['user_id']; ?>">
               <Br />
