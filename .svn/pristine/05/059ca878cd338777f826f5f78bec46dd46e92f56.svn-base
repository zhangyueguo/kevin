...
<div class="tdare">
    <table width="100%" cellspacing="0" class="dataTable">
        ...
        <tr class="tatr1">
			...
			<td align="left"><span ectype="order_by" fieldname="username">会员名</span></td>
			<td align="left"><span ectype="order_by" fieldname="presentname">礼品名称</span></td>
			<td align="left"><span ectype="order_by" fieldname="eggname">所属蛋类</span></td>
			<td align="left"><span ectype="order_by" fieldname="addtime">添加时间</span></td>
...
?>
        <tr class="tatr2">
			...
			<td align="left"><?php echo local_date("Y-m-d",$this->_var['eggpresentrec']['addtime']); ?></td>
