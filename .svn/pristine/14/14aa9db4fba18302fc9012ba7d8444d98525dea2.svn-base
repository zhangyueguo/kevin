    ...
    <div id="right">
        ...
        <div class="submenu">
            <ul class="tab">
                ...
                <li class="active <?php if (($this->_foreach['member_submenu']['iteration'] <= 1)): ?>first<?php endif; ?>"><h2><a href="index.php?app=store_worker">员工列表</a></h2></li>
...
?>
                                    ...
                                    <td><?php echo $this->_var['comworker']['juese']; ?></td>
                                    <td><?php echo $this->_var['comworker']['status']; ?></td>
