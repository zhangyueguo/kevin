...
?>
        <tr class="tatr2">
            <td class="firstCell"><?php if (! $this->_var['info']['code']): ?><input type="checkbox" class="checkitem" value="<?php echo $this->_var['info']['id']; ?>"/><?php endif; ?></td>
            ...
            <td><?php echo date("Y-m-d H:i:s",$this->_var['info']['add_time']); ?></td>
            ...
            <td>
				...
				<a href="index.php?app=supply_demand&amp;act=verify&amp;id=<?php echo $this->_var['info']['id']; ?>">审核</a> | 
                <a href="javascript:drop_confirm('您确定要删除这些记录吗？', 'index.php?app=supply_demand&amp;act=drop&amp;id=<?php echo $this->_var['info']['id']; ?>');">删除</a></td>
        </tr>
        <?php endforeach; else: ?>
        <tr class="no_data">
    ...
    <div id="dataFuncs">
        ...
        <div id="batchAction" class="left paddingT15">
            &nbsp;&nbsp;
            <input class="formbtn batchButton" type="button" value="删除" name="id" uri="index.php?app=supply_demand&act=drop" presubmit="confirm('您确定要删除这些记录吗？');" />
        </div>
    </div>
    <div class="clear"></div>
    <?php endif; ?>
