...
<div id="rightTop">
    <p>品牌团</p>
    <ul class="subnav">
        <li><?php if ($this->_var['wait_verify']): ?><a class="btn1" href="index.php?app=jubrand">管理</a><?php else: ?><span>管理</span><?php endif; ?></li>
        <li><a class="btn1" href="index.php?app=jubrand&amp;act=add">新增</a></li>
        <li><?php if ($this->_var['wait_verify']): ?><span>待审核</span><?php else: ?><a class="btn1" href="index.php?app=jubrand&amp;wait_verify=1">待审核</a><?php endif; ?></li>
    </ul>
</div>
<div class="mrightTop">
    <div class="fontl">
        <form method="get">
            <div class="left">
                <input type="hidden" name="app" value="jubrand" />
            ...
            <a class="left formbtn1" href="index.php?app=jubrand&wait_verify=<?php echo $this->_var['wait_verify']; ?>">撤销检索</a>
            <?php endif; ?>
      <span>
              </span></form>
    </div>
...
?>
        <tr class="tatr2">
            ...
            <?php endif; ?>
            <td class="handler" style="width:100px">
            <?php if ($this->_var['brand']['if_show'] == 1): ?>
            <a href="index.php?app=jubrand&amp;act=edit&amp;id=<?php echo $this->_var['brand']['brand_id']; ?>">编辑</a>  |  <a name="drop" href="javascript:drop_confirm('如果删除，可能会对涉及该活动的卖家和买家产生影响，您确定要删除吗？', 'index.php?app=jubrand&amp;act=drop&amp;id=<?php echo $this->_var['brand']['brand_id']; ?>');">删除</a>
            <?php else: ?>
			<a href="index.php?app=jubrand&amp;act=edit&amp;id=<?php echo $this->_var['brand']['brand_id']; ?>">编辑</a>  |
            <a href="index.php?app=jubrand&amp;act=pass&amp;id=<?php echo $this->_var['brand']['brand_id']; ?>">通过</a>  |  <a href="index.php?app=jubrand&amp;act=refuse&amp;id=<?php echo $this->_var['brand']['brand_id']; ?>">拒绝</a>       
            <?php endif; ?>
            </td>
        </tr>
        <?php endforeach; else: ?>
    ...
    <div id="dataFuncs">
        <div id="batchAction" class="left paddingT15">
            <?php if ($this->_var['wait_verify']): ?>
            &nbsp;&nbsp;
            <input class="formbtn batchButton" type="button" value="通过" name="id" uri="index.php?app=jubrand&act=pass" />
             &nbsp;&nbsp;
            <input class="formbtn batchButton" type="button" value="拒绝" name="id" uri="index.php?app=jubrand&act=refuse" />
            <?php else: ?>
            &nbsp;&nbsp;
            <input class="formbtn batchButton" type="button" value="删除" name="id" uri="index.php?app=jubrand&act=drop" presubmit="confirm('如果删除，可能会对涉及该活动的卖家和买家产生影响，您确定要删除吗？');" />
            <?php endif; ?>
        </div>
        <div class="pageLinks">
