                        ...
                        <div class="account_left">
                            ...
                            <div class="balanceNum">
                                ...
                                <div class="balanceBtn">
                                	<a href="<?php echo url('app=company_deposit&act=recharge'); ?>" class="btn-alipay"><span>充值</span></a>
                                	<a href="<?php echo url('app=company_deposit&act=withdraw'); ?>" class="btn-alipay btn-alipay-white"><span>提现</span></a>
                                    <a href="<?php echo url('app=company_deposit&act=transfer'); ?>" class="btn-alipay btn-alipay-white"><span>转账</span></a>
                                </div>
                        	</div>
                            <div class="shouxin">
                                <h1>授信额度</h1>
