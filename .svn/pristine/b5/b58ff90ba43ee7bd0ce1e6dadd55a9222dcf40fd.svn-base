<?php
class Seller_depositApp extends SellerdepositbaseApp
{
    ...
    {
         $this->Seller_depositApp();
    }

    function Seller_depositApp()
    {
        parent::__construct();
...
/*			$this->show_message('充值失败', 'back', 'index.php?app=deposit&act=rechargelist');*/
    ...
    function _get_member_submenu()
    {
        $data = array(
			...
			array(
				'name'  => 'deposit_config',
				'url'	=> 'index.php?app=seller_deposit&act=config',
			),
			array(
				'name'	=>	'recordlist',
				'url'	=>	'index.php?app=seller_deposit&act=recordlist',
			),
			
			array(
				'name'	=>	'indraw',
				'url'	=> 	'index.php?app=seller_deposit&act=drawlist',
			),
        );
		if(ACT=='withdraw' || ACT=='withdraw_confirm')
		{
			$data[] = array(
				...
				'url'	=>	'index.php?app=seller_deposit&act=withdraw',
			);
		}
		if(ACT=='record')
		{
			$data[] = array(
				'name'	=>	'record_detail',
				'url'	=>	'index.php?app=seller_deposit&act=record',
			);
		}
		if(ACT=='recharge')
		{
			$data[] = array(
				...
				'url'	=> 'index.php?app=seller_deposit&act=recharge',
			);
		}
		if(ACT=='monthbill')
		{
			$data[] = array(
				'name'	=> 'monthbill',
				'url'	=> 'index.php?app=seller_deposit&act=monthbill',
			);
		}
		if(ACT=='transfer')
		{
			$data[] = array(
				...
				'url'	=>	'index.php?app=seller_deposit&act=transfer',
			);
		}
		if(ACT=='frozenlist')
		{
			$data[] = array(
				'name'	=>	'frozenlist',
				'url'	=>	'index.php?app=seller_deposit&act=frozenlist',
			);
		}
