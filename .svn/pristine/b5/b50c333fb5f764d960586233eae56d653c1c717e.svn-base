...
class Seller_adminIndexApp extends MembersellerApp
{
    ...
    public function index()
    {
        ...
        if(IS_POST)
        {
            ...
            $this->_store_mod->edit(array('user_id'=>$user_id),$data);
        ...
        $store = $this->_store_mod->get_info($user_id);
    ...
    public function approve()
    {
        ...
        if(IS_POST)
        {
            ...
            $image_urls = $this->_uplocad_images($images,$user_id);
   ...
   public function security()
   {
       ...
       /* 当前用户中心菜单 */
       $this->_curitem('my_profile');
       $this->_config_seo('title', '安全设置');
      // parent::security(); // TODO: Change the autogenerated stub
       $this->display('seller.security.html');
   }
