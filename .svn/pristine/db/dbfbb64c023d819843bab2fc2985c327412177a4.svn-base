                ...
                if (data.retval.length > 0)
                {
                  ...
                  //  console.log(data[1].parent_id);
                         ...
                         for (i = 0; i < data.length; i++)
                         {
                             ...
                             /*if(data[i].store_id){
                                 $(_self).next("select").append("<option value='" + data[i].region_id + "'>" + data[i].region_name + "</option>");
                                 $("#region").append("<input type=hidden name=store_id value='"+data[i].store_id+"'>");
                                 $("#region").append("<input type=hidden name=store_name value='"+data[i].region_name+"'>");
                             }else{
                                 $(_self).next("select").append("<option value='" + data[i].region_id + "'>" + data[i].region_name + "</option>");
                             }*/
                         }
