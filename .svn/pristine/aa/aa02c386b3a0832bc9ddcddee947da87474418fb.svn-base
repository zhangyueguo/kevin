                        ...
                        <div class="info individual">
                            <table>
                                <tr>
                                    ...
                                    <th class="width4">企业名称: </th>
                                    <td><input type="text" class="text width_normal" name="company_name" value="<?php echo $this->_var['company']['companyname']; ?>" /></td>
                                </tr>
                                <tr>
                                    <th>电子邮件:</th>
                                    <td><input type="text" class="text width_normal" name="email" value="<?php echo $this->_var['company']['email']; ?>" /></td>
                                </tr>
                                <tr>
                                    <th>办公地址:</th>
                                    <!--<td> </td>-->
                                    ...
                                    <td class="paddingT15 wordSpacing5" >
                                        <div id="region">
                                            <input type="hidden" name="region_id" value="<?php echo $this->_var['company']['region_id']; ?>" class="mls_id" />
                                            <input type="hidden" name="region_name" value="<?php echo htmlspecialchars($this->_var['company']['region_name']); ?>" class="mls_names" />
                                ...
                                <tr>
                                    ...
                                    <th>负责人: </th>
                                    <td>
                                        <input type="text" class="text width_normal" name="lxrname" id="birthday" value="<?php echo $this->_var['company']['lxrname']; ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>部门:</th>
                                    <td> <input type="text" class="text width_normal" name="section" value="<?php echo $this->_var['company']['section']; ?>" /></td>
                                </tr>
                                <tr>
                                    <th>固定电话:</th>
                                    <td><input type="text"  class="text width_normal"name="tel" value="<?php echo $this->_var['company']['tel']; ?>" /></td>
                                </tr>
                                <tr>
                                    <th>手机:</th>
                                    <td><input type="text"  class="text width_normal"name="phone" value="<?php echo $this->_var['company']['phone']; ?>" /></td>
                                </tr>
                                <?php if ($this->_var['edit_avatar']): ?>
                                <tr>
                                    <th>portrait:</th>
